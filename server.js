...
app.use(express.static(__dirname)); // 🔥 يخدم جميع الملفات الثابتة (index.html, CSS, JS)
...
// إعادة توجيه أي طلب غير معروف إلى index.html (للتوجيه في تطبيقات الصفحة الواحدة)
app.get('*', (req, res) => {
